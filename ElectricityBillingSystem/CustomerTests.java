...
import com.project.ElectricityBillingSystem.ServiceImpl.CustomerServiceImpl;
...
public class CustomerTests {
	...
	void getCustomerTest() {
		CustomerEntity customerEntity = new CustomerEntity(1,"ramu", "3798827282", "ramu@gmail.com", 32, 33, 43, 53);
		Optional<CustomerEntity> result;
		try {
			result = customerServiceImpl.getCustomer(1);
