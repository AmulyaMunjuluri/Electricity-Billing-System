...
public class BillingEntity {
	...
	public BillingEntity(int id, String customer_id, int units_consumed, int amount, String due_date, String start_date,
			String end_date) {
		super();
		this.id = id;
	...
	public String toString() {
		return "BillingEntity [id=" + id + ", customer_id=" + customer_id + ", units_consumed=" + units_consumed
