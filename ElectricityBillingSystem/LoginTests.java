...
import com.project.ElectricityBillingSystem.ServiceImpl.LoginServicesImpl;
...
class LoginTests {
	...
	@Test
	void addLoginTest() {
		LoginEntity LoginEntity = new LoginEntity("mahender@gmail.com", "iamfull");
	...
	void getLoginTest() {
		...
		try {
			result = loginServiceImple.getLogin("mahender@gmail.com");
	...
	void updateLoginTest() {
		LoginEntity LoginEntity = new LoginEntity("mahender@gmail.com", "iamnotfull");
